...
class VariationalAutoencoder(object):
    ...
    def _sample_z(self, z_mean, z_log_var):
        ...
        z = None
        ####### Implementation Here ######
        z = z_mean + tf.random_normal(tf.shape(z_log_var))*tf.exp(0.5*z_log_var)
        return z
    ...
    def _encoder(self, x):
        ...
        z_log_var = fully_connected(layer2, self._nlatent, activation_fn=None)
    ...
    def _decoder(self, z):
        ...
        f = fully_connected(layer2, self._ndims, activation_fn=None)
        return f
    ...
    def _reconstruction_loss(self, f, x_gt):
        ...
        recon_loss = None
        ####### Implementation Here ######
        recon_loss = tf.reduce_sum(0.5*tf.square(x_gt - f), axis=1)
        return recon_loss
