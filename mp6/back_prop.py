...
class Neural_Network():
    ...
    def forward(self, X):
        ...
        '''
        b = self.sigmoid(self.fully_connected(X, self.U, self.e))
        c = self.sigmoid(self.fully_connected(b, self.W, self.f))
        return c
    ...
    def error_at_layer1(self, delta_k, W, b):
        ...
        '''
        delta_j = np.dot(delta_k, W.T) * self.sigmoidPrime(b)
        return delta_j
