...
def toy_fn_2(arg1, arg2):
    ...
    '''
    # Input your code here
    sum_1d = tf.reduce_sum(arg1, 1)
    arg2_max = tf.reduce_max(arg2)
    ret = tf.subtract(sum_1d, arg2_max)
...
def toy_fn_3(arg1, arg2):
    ...
    '''
    # Input your code here
    transpose_arg1 = tf.reshape(arg1, [2, 1])
    transpose_arg2 = tf.reshape(arg2, [2, 1])
    concat_arg1arg2 = tf.concat([transpose_arg1, transpose_arg2], 1)
    ret = tf.reshape(concat_arg1arg2, [4])
